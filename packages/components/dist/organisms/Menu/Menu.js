...
var classesHeader = (0, _classnames.default)(
...
var classesLogo = (0, _classnames.default)(
  "flex relative",
  "p-4",
  "items-center justify-items-center",
  "border-r border-neutral-300"
);
var classesLanguages = (0, _classnames.default)(
  "flex flex-start flex-grow",
  "px-6 my-1",
  "border-b border-neutral-300",
  "h-6"
);
var classesOptionsContainer = (0, _classnames.default)(
  "flex",
  "border-b border-neutral-300",
  "my-1",
  "justify-items-end",
...
var classesOptionsTitle = (0, _classnames.default)(
  "flex flex-nowrap relative ",
  "pr-7",
  "text-neutral-500 font-principal"
);
var classesOptions = (0, _classnames.default)(
...
var classesNavContainer = (0, _classnames.default)(
  "flex flex-grow relative",
  "px-6",
  "items-center"
);
var classesSearch = (0, _classnames.default)(
  "flex",
  "justify-center",
  "cursor-pointer",
...
var classButton = (0, _classnames.default)(
  "flex",
  "items-start align-center justify-center text-center",
  "pr-6",
  "font-bold text-sm"
);
var classesHeaderMobile = (0, _classnames.default)(
...
var classesMenuMobile = (0, _classnames.default)(
  "py-4 px-2",
  "w-12 h-12",
  "flex items-center justify-center",
  "cursor-pointer"
);
var classesLogoMobile = (0, _classnames.default)(
  "flex relative",
  "w-full",
  "items-center justify-items-center justify-center"
);
var classesSearchContainer = (0, _classnames.default)(
  "flex relative flex-end hidden",
  "border-l-2  border-neutral-300",
  "px-2"
);
var classesSearchMobile = (0, _classnames.default)(
  "py-4 px-2",
  "w-12 h-12",
  "flex hidden",
...
var Menu = function Menu(_ref) {
  ...
  //classes
  var classLanguages = (0, _classnames.default)(
    classesLanguages,
    _defineProperty({}, "hidden", !languages)
  );
                      ...
                      children: data.menus.map(function (element, itemIndex) {
                        if (element.items.length) {
                          return /*#__PURE__*/ (0, _jsxRuntime.jsx)(
                            "li",
                            {
                              className: (0, _classesHelper.getClassItem)(
                                true,
                                element.active
                              ),
      ...
      /*#__PURE__*/ (0, _jsxRuntime.jsx)("div", {
        ...
        children: data.menus[index].items.map(function (subitem, subitemIndex) {
          return /*#__PURE__*/ (0, _jsxRuntime.jsx)(
            ...
            {
              className:
                " border-r border-neutral-300 h-auto flex flex-row flex-grow flex-1 flex-nowrap flex-inline relative ",
